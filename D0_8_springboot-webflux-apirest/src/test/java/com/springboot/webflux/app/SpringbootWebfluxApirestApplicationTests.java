...
//*********
//CLASE 85 : ESTA VERSIÓN DE LA APP SE REALIZA EN LA CLASE 85, DONDE SE PONEN LAS URI'S EN EL APPLICATION.PROPERTIES, PARA PODER APLICAR LAS PRUEBAS UNITARIAS AL HANDLER Y AL CONTROLLER.


//CLASE85
	//8.0.-SE INYECTA EL VALOR STRING DE LA URL CON @VALUE. Y SE CAMBIA EL STRING POR URL EN TODOS LOS MÉTODOS.
	//8.1.-SE AGREGA ".producto" PARA QUE ACEPTE EL TEST DEL MÉTODO CREAR DEL CONTROLLER.
	//8.2.-SE CAMBIA expectBody(Producto.class) YA QUE EL MÉTODO CREAR DEL CONTROLLER DEVUELVE UN MAP CON LOS DATOS DEL PRODUCTO, MIENTRAS QUE EL MÉTODO CREAR DEL HANDLER DEVUELVE UN OBJ PRODUCTO.
		//PARA MANEJAR AMBOS TIPOS DE OBJ DE LOS MÉTODOS CREAR, SE USA  ".expectBody(new ParameterizedTypeReference<LinkedHashMap<STRING,OBJECT>())" LA IMPLEMENTACION LinkedHashMap QUE TIENE POR PARÁMETROS STRING Y OBJECT.
	//8.3.-.get("producto") : PRODUCTO, HACE REFERENCIA A AL "respuesta.put("producto", p);" QUE ESTÁ EN EL MÉTODO CREAR DEL CONTROLLER (LÍNEA 158).
		//DE ESTA MANERA SE OBTIENE EL OBJECT DEL PRODUCTO. 
		//Producto p = new ObjectMapper().convertValue(o, Producto.class); ... Y A CONTINUACIÓN SE PASA EL OBJECT "o" A PRODUCTO.

//@AutoConfigureWebTestClient   //ESTA ES PARA USARLA CON MOCK. Y SE CAMBIA RANDOM_PORT POR MOCK.
...
class SpringbootWebfluxApirestApplicationTests {
	...
	public void crearTest() {
		...
		.jsonPath("$.producto.nombre").isEqualTo("Mesa comedor X")
